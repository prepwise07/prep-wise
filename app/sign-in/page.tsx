            ...
            <div className="auth-container">
                <div className={`auth-card w-full max-w-md mx-4 p-10 py-12 relative z-10 animate-scale-in ${(isOAuthLoading || isLoading) ? 'flipping' : ''}`}>
                    ...
                    <div className="flex flex-col items-center justify-center mb-10">
                        ...
                        <h2 className="text-xl font-bold bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">Welcome Back</h2>
                        <p className="text-sm text-white/40 mt-1">Sign in to your PrepWise account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-white/50 uppercase tracking-widest ml-1">Account Email</label>
                            <input
                                type="email"
                    ...
                    <p className="text-center text-sm text-white/40 mt-10">
                        Need an account?{" "}
                        <Link href="/sign-up" className="text-[var(--primary)] font-bold hover:underline underline-offset-4 transition-all">
                            Create one now →
                        </Link>
                    </p>
                </div>
