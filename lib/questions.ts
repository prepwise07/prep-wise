...
export const questionBank: Question[] = [
    ...
    // ─── New SQL Questions ───
    {
        ...
        category: "SQL",
        difficulty: "Easy",
        question: "What is SQL and what are the different types of SQL commands (DDL, DML, DCL, TCL)?",
        keyPoints: ["Structured Query Language for managing RDBMS", "DDL: CREATE, DROP, ALTER", "DML: INSERT, UPDATE, SELECT, DELETE", "DCL: GRANT, REVOKE", "TCL: COMMIT, ROLLBACK"],
    },
    {
        id: "sql5",
        category: "SQL",
        ...
        keyPoints: ["SQL is a language", "MySQL is an open-source RDBMS that uses SQL", "SQL is used across many databases like PostgreSQL, Oracle, etc."],
    },
    {
        id: "sql6",
        category: "SQL",
        difficulty: "Easy",
        question: "What are Primary Keys, Foreign Keys, and Unique Keys?",
        keyPoints: ["Primary Key: Unique identifier for a row, cannot be NULL", "Foreign Key: Reference to a Primary Key in another table", "Unique Key: Ensures all values in a column are different, can allow one NULL"],
    },
    {
        id: "sql7",
        category: "SQL",
        ...
        keyPoints: ["DELETE is DML (selective, rollback possible)", "TRUNCATE is DDL (clears all rows, faster, no rollback in some DBs)", "DROP is DDL (removes table structure and data permanently)"],
    },
    {
        id: "sql8",
        category: "SQL",
        difficulty: "Medium",
        question: "What are SQL constraints? Explain NOT NULL, DEFAULT, and CHECK.",
        keyPoints: ["NOT NULL: Column cannot have NULL values", "DEFAULT: Provides a default value if none is specified", "CHECK: Ensures all values in a column satisfy a specific condition"],
    },
    {
        id: "sql9",
        category: "SQL",
        difficulty: "Medium",
        question: "What is a subquery? Explain the difference between a correlated and non-correlated subquery.",
        keyPoints: ["Nested query inside another query", "Non-correlated: Independent, executes once", "Correlated: Depends on the outer query, executes for each row"],
    },
    {
        id: "sql10",
        category: "SQL",
        difficulty: "Hard",
        question: "What is indexing? Compare Clustered and Non-Clustered indexes.",
        keyPoints: ["Performance tuning for faster searches", "Clustered: Physically reorders data, one per table", "Non-Clustered: Separate structure, points to actual data, multiple per table"],
    },
    {
        id: "sql11",
        category: "SQL",
        difficulty: "Hard",
        question: "Explain Database Normalization (1NF, 2NF, 3NF). What is Denormalization?",
        keyPoints: ["Normalization: Reducing redundancy and improving integrity", "1NF: Atomic values", "2NF: No partial dependency", "3NF: No transitive dependency", "Denormalization: Intentionally adding redundancy for read performance"],
    },
    {
        id: "sql12",
        category: "SQL",
        difficulty: "Hard",
        question: "Describe Views, Stored Procedures, and Triggers in SQL.",
        keyPoints: ["View: Virtual table based on a query result", "Stored Procedure: Reusable SQL code stored in DB", "Trigger: Code that automatically executes on INSERT/UPDATE/DELETE"],
    },
    {
        id: "sql13",
        category: "SQL",
        difficulty: "Hard",
        question: "How do you find the second highest salary in an employees table?",
        keyPoints: ["Using subqueries: WHERE salary < (SELECT MAX(salary)...)", "Using OFFSET: ORDER BY salary DESC LIMIT 1 OFFSET 1", "Using Window Functions: DENSE_RANK()"],
    },
    {
        id: "sql14",
        category: "SQL",
        difficulty: "Medium",
        question: "What are Aggregate Functions? List at least five with examples.",
        keyPoints: ["Functions that perform calculation on multiple values", "SUM(), COUNT(), AVG(), MIN(), MAX()", "Usually used with GROUP BY"],
    },
    {
        id: "sql15",
        category: "SQL",
        difficulty: "Hard",
        question: "Explain Window Functions like ROW_NUMBER(), RANK(), and DENSE_RANK().",
        keyPoints: ["Perform calculation across rows related to current row", "ROW_NUMBER: Unique sequential ID", "RANK: Same rank for ties, skips next (1, 2, 2, 4)", "DENSE_RANK: Same rank for ties, no skip (1, 2, 2, 3)"],
    },
    {
        id: "sql16",
        category: "SQL",
        difficulty: "Medium",
        question: "Write a SQL query to find duplicate records in a table based on an email column.",
        keyPoints: ["SELECT email, COUNT(email)", "GROUP BY email", "HAVING COUNT(email) > 1"],
    },
